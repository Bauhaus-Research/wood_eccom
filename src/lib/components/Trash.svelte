<script>
	import { rmToCartAll } from '$lib/stores/cartStore';
...
<svg
	...
	class="h-10 w-10 opacity-50 hover:opacity-100 transition-opacity duration-300 ease-in-out"
	width="800px"
	height="800px"
	viewBox="0 0 24 24"
	fill="none"
