...
<section class="grid grid-cols-12 gap-4 w-full bg-white list-none p-0">
<div style="background-image: url('workspace_prod.webp');" class="col-span-12 h-96 w-full"></div>
