<script>
  ...
  let ascending = true;
    ...
    // list of dining types
    const diningTypes = [
        { id: 1, image: "bed.webp", name: 'Dining' },
        { id: 2, image: "bed.webp", name: 'Gathering' },
        { id: 3, image: "bed.webp", name: 'High Dining' },
        { id: 4, image: "bed.webp", name: 'Dining Chairs' },
        { id: 5, image: "bed.webp", name: 'Benches' },
        { id: 6, image: "bed.webp", name: 'Kitchen Islands' },
    ];
</script>
...
<main class="shadow-md sm:shadow-md md:shadow-md grid grid-cols-12 max-h-[99vh] h-fit max-w-full  gap-4 rounded-md w-full bg-white overflow-x-auto list-none p-0">
	<div class="h-96 w-full bg-green-900 col-span-12 overflow-x-clip">
        ...
        <section class=" w-full  col-span-12 overflow-x-clip">

            <div class="bg-green-200 col-span-12 flex flex-row justify-center items-center mx-auto">
                {#each diningTypes as items}
                <div class=" flex-col mx-1">
                    <img src="url('bauhausresearch_flat_design_bauhaus_app_screens_animated_8c469f6d-c6a5-4879-bbd8-6f72874738f1.PNG');" alt="hi" class="h-24 w-36 bg-cover " />
                    <h4>{items.name}</h4>
                </div>
                {/each}
            </div>
